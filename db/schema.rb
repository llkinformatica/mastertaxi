...
ActiveRecord::Schema[7.0].define(version: 2022_11_09_131854) do
  ...
  create_table "cooperados", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "nome"
    t.bigint "matricula"
    t.string "apelido"
    t.date "nascimento"
  ...
  create_table "localidades", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "nome"
